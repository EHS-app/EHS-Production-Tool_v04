...
const Button = ({ children, className, variant = "primary", size = "default" }: { children: React.ReactNode, className?: string, variant?: "primary" | "secondary" | "ghost", size?: "default" | "sm" | "icon" }) => {
  const variants = {
    primary: "bg-[#7B5BFF] hover:bg-[#6A4CE5] text-white shadow-[0_0_15px_rgba(123,91,255,0.3)] border border-transparent",
...
export function Linear() {
  return (
    <div className="dark bg-[#1C1C24] text-gray-300 min-h-screen font-sans selection:bg-[#7B5BFF]/30 flex flex-col md:flex-row overflow-hidden">
      <style>{`
        .linear-glow {
          background: radial-gradient(circle at 50% 0%, rgba(123, 91, 255, 0.15) 0%, rgba(28, 28, 36, 0) 60%);
        }
      ...
      <aside className="w-full md:w-64 border-r border-white/5 bg-[#1C1C24] flex flex-col shrink-0 relative z-20">
        ...
        <div className="h-14 flex items-center px-4 border-b border-white/5 cursor-pointer hover:bg-white/5 transition-colors group">
          <div className="h-6 w-6 rounded bg-gradient-to-br from-[#7B5BFF] to-[#4C3B99] flex items-center justify-center text-white font-bold text-xs shadow-inner">
            E
          </div>
        ...
        <div className="flex-1 overflow-y-auto linear-scrollbar py-2 px-3">
          <div className="space-y-0.5">
            ...
            <a href="#" className="flex items-center gap-2 px-2 py-1.5 rounded-md bg-[#7B5BFF]/10 text-[#7B5BFF] text-sm font-medium">
        ...
        <div className="p-6 md:p-8 max-w-6xl mx-auto w-full z-10 space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="p-4 bg-gradient-to-b from-[#25252F] to-[#1F1F28] hover:border-white/10 transition-colors">
              ...
              <ProgressBar value={18} max={22} colorClass="bg-[#7B5BFF]" />
            </Card>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-medium text-gray-100 flex items-center gap-2">
                    <Users className="w-4 h-4 text-[#7B5BFF]" /> Crew Schedule
                  </h2>
                ...
                <Card className="overflow-hidden">
                      ...
                      <tbody className="divide-y divide-white/5 text-gray-300">
                        <tr className="hover:bg-white/[0.02] transition-colors group">
                          ...
                          <td className="p-1 border-l border-white/5">
                            <div className="bg-[#7B5BFF]/20 border border-[#7B5BFF]/30 text-[#7B5BFF] text-xs py-1.5 px-2 rounded flex flex-col items-center justify-center h-full">
                  ...
                  <div className="bg-[#1C1C24]/80 p-2.5 border-t border-white/5 text-xs flex justify-between text-gray-500 items-center">
                    <div className="flex gap-4">
                      <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-[#7B5BFF]"></div> Bekreftet</span>
                  ...
                  <Card className="p-3.5 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between mt-2 pt-2 border-t border-white/5">
                        ...
                        <a href="#" className="text-xs text-[#7B5BFF] hover:underline flex items-center">Detaljer <ArrowUpRight className="w-3 h-3 ml-0.5"/></a>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="p-3.5 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between mt-2 pt-2 border-t border-white/5">
                        ...
                        <a href="#" className="text-xs text-[#7B5BFF] hover:underline flex items-center">Meny <ArrowUpRight className="w-3 h-3 ml-0.5"/></a>
                      </div>
                    </div>
                  </Card>
                </div>
                ...
                <Card className="p-4">
                  <div className="space-y-4 relative before:absolute before:inset-0 before:ml-[11px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
                    ...
                    <div className="relative flex items-start gap-4">
                      <div className="absolute left-0 h-full w-0.5 bg-white/10 ml-[11px] -z-10" />
                      <div className="w-6 h-6 rounded-full bg-[#1C1C24] border border-white/10 flex items-center justify-center shrink-0 mt-0.5">
                        <Share className="w-3 h-3 text-[#7B5BFF]" />
                      </div>
                      <div className="flex-1 text-sm">
                    ...
                    <div className="relative flex items-start gap-4">
                      <div className="absolute left-0 h-full w-0.5 bg-white/10 ml-[11px] -z-10" />
                      <div className="w-6 h-6 rounded-full bg-[#1C1C24] border border-[#7B5BFF]/30 flex items-center justify-center shrink-0 mt-0.5 shadow-[0_0_8px_rgba(123,91,255,0.4)]">
                        <Plus className="w-3 h-3 text-[#7B5BFF]" />
                      </div>
                      <div className="flex-1 text-sm">
