...
const Button = ({ children, className, variant = "primary", size = "default" }: { children: React.ReactNode, className?: string, variant?: "primary" | "secondary" | "ghost", size?: "default" | "sm" | "icon" }) => {
  const variants = {
    primary: "bg-[#F88000] hover:bg-[#D96E00] text-white shadow-[0_0_15px_rgba(248,128,0,0.3)] border border-transparent",
...
export function LinearEHS() {
  return (
    <div className="dark bg-[#1C1C24] text-gray-300 min-h-screen font-sans selection:bg-[#F88000]/30 flex flex-col md:flex-row overflow-hidden">
      <style>{`
        .linear-glow {
          background: radial-gradient(circle at 50% 0%, rgba(248, 128, 0, 0.15) 0%, rgba(28, 28, 36, 0) 60%);
        }
