    ...
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      <div className="absolute top-[8vh] left-[6vw] right-[6vw]">
        ...
        <h2 className="text-[4.4vw] leading-[1.05] font-extrabold tracking-tight mt-[2.5vh] [text-wrap:balance]">
          Six features, one chain
        </h2>
      </div>

      <div className="absolute left-[6vw] right-[6vw] top-[44vh] grid grid-cols-[1fr_1.6vw_1fr_1.6vw_1fr_1.6vw_1fr_1.6vw_1fr_1.6vw_1fr] items-start gap-0">
        <div className="border-t-[3px] border-accent pt-[2vh]">
          <div className="text-[1.2vw] tracking-[0.25em] uppercase text-accent font-bold mb-[1.5vh]">
            01
          </div>
          <h3 className="text-[1.2vw] font-extrabold leading-tight [text-wrap:balance]">
            Search → Request → Accept
          </h3>
        </div>
        <div className="text-[1.6vw] text-muted text-center mt-[5.5vh] font-light">
          →
        </div>
        <div className="border-t-[3px] border-accent pt-[2vh]">
          <div className="text-[1.2vw] tracking-[0.25em] uppercase text-accent font-bold mb-[1.5vh]">
