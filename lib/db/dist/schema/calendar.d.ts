...
export declare const calendarAvailabilityRuleExceptionsTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "calendar_availability_rule_exceptions";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "calendar_availability_rule_exceptions";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
