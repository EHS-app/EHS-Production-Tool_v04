...
export declare const timeEntriesTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        producerAdjustmentMinutes: import("drizzle-orm/pg-core").PgColumn<{
            name: "producer_adjustment_minutes";
            tableName: "time_entries";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
        ...
        producerBreakMinutes: import("drizzle-orm/pg-core").PgColumn<{
            name: "producer_break_minutes";
            tableName: "time_entries";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
        ...
        adjustedByUserId: import("drizzle-orm/pg-core").PgColumn<{
        ...
        adjustedAt: import("drizzle-orm/pg-core").PgColumn<{
            name: "adjusted_at";
            tableName: "time_entries";
            dataType: "date";
            columnType: "PgTimestamp";
        ...
        approvedRateMinor: import("drizzle-orm/pg-core").PgColumn<{
            name: "approved_rate_minor";
            tableName: "time_entries";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
        ...
        approvedFlatFeeMinor: import("drizzle-orm/pg-core").PgColumn<{
            name: "approved_flat_fee_minor";
            tableName: "time_entries";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
...
export declare const TIME_ENTRY_STATUSES: readonly ["draft", "submitted", "approved", "rejected", "flagged", "locked"];
