...
export const calendarAvailabilityTable = pgTable(
...
export const calendarAvailabilityRulesTable = pgTable(
...
/** Suppresses one local-date occurrence of a bounded weekly availability rule. */
export const calendarAvailabilityRuleExceptionsTable = pgTable(
  "calendar_availability_rule_exceptions",
  {
    ...
    ruleId: text("rule_id")
      .notNull()
      .references(() => calendarAvailabilityRulesTable.id, {
        onDelete: "cascade",
      }),
...
export const calendarBusyIntervalsTable = pgTable(
  "calendar_busy_intervals",
  {
    id: text("id").primaryKey(),
    connectionId: text("connection_id")
      .notNull()
      .references(() => calendarConnectionsTable.id, { onDelete: "cascade" }),
    startsAt: timestamp("starts_at", { withTimezone: true }).notNull(),
    endsAt: timestamp("ends_at", { withTimezone: true }).notNull(),
...
export const calendarOAuthStatesTable = pgTable(
...
export const calendarHoldsTable = pgTable(
  "calendar_holds",
  {
    id: text("id").primaryKey(),
...
export const calendarSyncJobsTable = pgTable(
  "calendar_sync_jobs",
  {
    id: text("id").primaryKey(),
    connectionId: text("connection_id")
